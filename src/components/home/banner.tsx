              ...
              <span className="relative inline-block">
                ...
                >
                  ...
                  />
                            ...
                            WHY CHOOSE DEEP TECHNOLOGIES
                        </h2>
                        <p className="text-base text-gray-700 md:text-lg">
                            Using deep domain expertise of our software developers,
                            we create impactful digital solutions that drive
            ...
            <div className="relative px-4 sm:px-0">
                ...
                <div className="relative grid mx-auto overflow-hidden bg-white divide-y rounded shadow sm:divide-y-0 sm:divide-x sm:max-w-screen-sm sm:grid-cols-3 lg:max-w-screen-md">
                    <div className="inline-block p-8 text-center">
                        <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-purple-400">
                            <svg
