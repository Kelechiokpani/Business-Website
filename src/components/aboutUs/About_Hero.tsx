    ...
    return (
        <>
            <div className="relative h-[640px] w-full bg-red-500/20 sm:h-[55vh] md:h-[640px]">
                ...
                {/*/>*/}
                <img
                    src="https://dtworldserver.verydeeptech.com/file/6305e5b0c0c3f66c6ee23917?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
                ...
                <div className="absolute inset-0 bg-neutral-900/70">
                    <div className="mx-auto max-w-screen-lg">
                        ...
                        <div className="mx-4 mt-16 flex flex-col ">
                            ...
                            <span className="mt-8 text-lg text-white sm:text-5md">
                                We are a digital transformation consultancy and engineering company
                                that delivers
                                <br/>
                                cutting edge solutions for global organisations and technology startups.
                                <br/>
                                we have been helping companies and established brands reimagine their business
                                <br/>through digitalisation and have
                                successfully built and implemented a range of great software <br/>products for various clients .
                        </span>
                            <div className="mt-8">
                                <SearchForm />
                            </div>
