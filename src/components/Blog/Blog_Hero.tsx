  ...
  return (
    <>
      <div className="relative h-[640px] w-full bg-red-500/20 sm:h-[55vh] md:h-[640px]">
        <img
            src="https://dtworldserver.verydeeptech.com/file/6305e74ac0c3f66c6ee23a49?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
        ...
        <div className="absolute inset-0 bg-neutral-900/70">
          <div className="mx-auto max-w-screen-lg">
            ...
            <div className="mx-4 mt-16 flex flex-col items-center text-center">
              <h1 className="text-2xl font-extrabold uppercase tracking-wide text-white sm:text-4xl md:text-5xl lg:text-6xl">
                Trending News
              </h1>
